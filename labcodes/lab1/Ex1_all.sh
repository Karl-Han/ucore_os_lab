make: Warning: File 'obj/sign/tools/sign.d' has modification time 0.42 s in the future
+ cc kern/init/init.c
...
10000+0 records in
10000+0 records out
5120000 bytes (5.1 MB, 4.9 MiB) copied, 0.351976 s, 14.5 MB/s
dd if=bin/bootblock of=bin/ucore.img conv=notrunc
1+0 records in
1+0 records out
512 bytes copied, 0.000278552 s, 1.8 MB/s
dd if=bin/kernel of=bin/ucore.img seek=1 conv=notrunc
146+1 records in
146+1 records out
74816 bytes (75 kB, 73 KiB) copied, 0.00704325 s, 10.6 MB/s
